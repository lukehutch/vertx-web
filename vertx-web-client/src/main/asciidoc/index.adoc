...
You can also use {@link io.vertx.ext.web.client.PathTemplate} to define path templates following the same syntax of Vert.x Web

[source,$lang]
----
{@link examples.WebClientExamples#pathTemplate(io.vertx.ext.web.client.WebClient)}
----
